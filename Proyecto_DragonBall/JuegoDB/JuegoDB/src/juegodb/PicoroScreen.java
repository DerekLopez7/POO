 ...
 * @author hecto
 */
public class PicoroScreen extends javax.swing.JFrame {
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        // TODO add your handling code here:
        p1.entrenar();
        actualizarBarras(); // Actualiza la barra de progreso       
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PicoroScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PicoroScreen().setVisible(true);
            }
        });
    }

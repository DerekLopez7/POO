...
public class PlayerScreen extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        GokuScreen_1 nf= new GokuScreen_1(this);
        windows.add(nf);
        nf.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        VegetaScreen_1 nf= new VegetaScreen_1(this);
        windows.add(nf);
        nf.setVisible(true);
        //ayuda a que no se acumulen las ventanas
        this.close();  
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        FrezzerScreen_1 nf= new FrezzerScreen_1(this);
        windows.add(nf);
        nf.setVisible(true);
        //ayuda a que no se acumulen las ventanas
        this.close(); 
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        KingColdScreen_1 nf= new KingColdScreen_1(this);
        windows.add(nf);
        nf.setVisible(true);
        //ayuda a que no se acumulen las ventanas
        this.close(); 
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        PicoroScreen_1 nf= new PicoroScreen_1(this);
        windows.add(nf);
        nf.setVisible(true);
        if(nf.getBarValue()==0) closeAllWindows();
        //ayuda a que no se acumulen las ventanas
        this.close(); 
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        VeggettoScreen_1 nf= new VeggettoScreen_1(this);
        windows.add(nf);
        nf.setVisible(true);
        //ayuda a que no se acumulen las ventanas
        this.close(); 
    ...
    public void passTurn(){
        if(!windows.isEmpty()){
            windows.get(currentTurn).setEnabled(false);
            currentTurn = (currentTurn + 1) % windows.size();
            windows.get(currentTurn).setEnabled(true);
        }
    }
    
    private void intializeWindows(){
        for(int i=0;i<windows.size();i++){
            windows.get(i).setEnabled(i == currentTurn);
        }
    }
    ...
    class FondoPanel3 extends JPanel{
        ...
        public void paint(Graphics g){
            imagen = new ImageIcon(getClass().getResource("/imagenes/goku.jpg")).getImage();
